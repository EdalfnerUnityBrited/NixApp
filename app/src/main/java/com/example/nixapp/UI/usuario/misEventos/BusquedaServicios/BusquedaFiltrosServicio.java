    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fecha1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(BusquedaFiltrosServicio.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                fecha1.setText(year + "-" + (monthOfYear + 1) + "-" + dayOfMonth);
                                fechaInicio= fecha1.getText().toString();
                                Toast.makeText(BusquedaFiltrosServicio.this, fechaInicio, Toast.LENGTH_SHORT).show();
                            }
                        }, ano, mes, dia);
                picker.show();
        ...
        fecha2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker2 = new DatePickerDialog(BusquedaFiltrosServicio.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                fecha2.setText(year + "-" + (monthOfYear + 1) + "-" + dayOfMonth);
                                fechaFinal= fecha2.getText().toString();
                                Toast.makeText(BusquedaFiltrosServicio.this, fechaFinal, Toast.LENGTH_SHORT).show();
                            }
                        }, ano2, mes2, dia2);
                picker2.show();
            }
