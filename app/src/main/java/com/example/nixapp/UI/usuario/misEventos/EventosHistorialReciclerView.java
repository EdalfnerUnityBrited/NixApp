...
public class EventosHistorialReciclerView extends RecyclerView.Adapter<EventosHistorialReciclerView.ViewHolder> {

    private final List<Eventos> mValues;
    private final HistorialFragment.OnListFragmentInteractionListener mListener;

    public EventosHistorialReciclerView(List<Eventos> items, HistorialFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
