...
public class ServiciosBusquedaAdapter extends ArrayAdapter<EventosItems> {

    public ServiciosBusquedaAdapter(Context context, ArrayList<EventosItems> countryList) {
