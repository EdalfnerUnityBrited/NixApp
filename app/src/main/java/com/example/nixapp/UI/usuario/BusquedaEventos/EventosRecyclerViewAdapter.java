...
public class EventosRecyclerViewAdapter extends RecyclerView.Adapter<EventosRecyclerViewAdapter.ViewHolder> {
    ...
    private final BuscarEventos.OnListFragmentInteractionListener mListener;

    public EventosRecyclerViewAdapter(List<Eventos> items, BuscarEventos.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
