...
public class ServiciosAdapter extends ArrayAdapter<ServiciosItems> {

    public ServiciosAdapter(Context context, ArrayList<ServiciosItems> countryList) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        ServiciosItems currentItem = getItem(position);
